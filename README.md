...
<video width = 100%  height = 300 src ="videos/Transformer.mp4" alt = "Transformer Demo" title = "Transformer" preload controls auto loop autoplay>
 </video>Video 1: Transformer animation</i></b> </p>
</div>
...
<div align = "middle" ><p>
 <img  width = 100%  src = "images/Transformer.png" alt = "Transformer" title = "Transformer">Figure 1: Illustration of transformer used for the project in <b><i>LTSpice</i></b> </p>
</div>
...
<div align = "middle" ><p>
 <img  width = 100%  src = "images/TransformerSimulation.png"  alt = "TransformerSimulation" title = "Transformer">Figure 2: Plot of Input(Green) and Output(Blue) signals of Transformer in <b><i>LTSpice</i></b> </p>
</div>
...
<video width = 100%  height = 400 src ="videos/Rectifier.mp4" alt = "Rectifier Demo" title = "Rectifier" controls loop autoplay>
 </video>
...
<div align = "middle" ><p>
 <img  width = 100%  src = "images/Rectifier.png"  alt = "Rectifier" title = "Rectifier">Figure 3: Rectifier Circuit Simulation in <b><i>LTSpice</i></b> </p>
</div>
...
<div align = "middle" ><p>
 <img  width = 100%  src = "images/RectifierGraph.png"  alt = "RectifierGraph" title = "RectifierGraph">Figure 4: Output Plot of Rectifier output in <b><i>LTSpice</i></b> </p>
</div>
...
<div id = filter align = "middle" ><p>
 <img  width = 100%  src = "images/RectifierWithFilter.png"  alt = "Rectifier With Filter" title = "RectifierWithFilter">Figure 5: Rectifier and Filter Circuit Simulation in <b><i>LTSpice</i></b> </p>
</div>
...
<div id = filter align = "middle" ><p>
 <img  width = 100%  src = "images/RectifierWithFilterGraph.png"  alt = "Graph of Rectifier With Filter" title = "RectifierWithFilter">Figure 6: Graphed Rectifier and Filter Circuit Simulation in <b><i>LTSpice</i></b> </p>
</div>
<br>
