...
![Regulator](images/Regulator.gif)
 <div align = "middle" ><p>Video 1: Regulated DC Power Supply Animation </p>
</div>
...
<div align = "middle" ><p>Figure 1: NPN BJT Amplifier </p>
</div>
...
<div id = filter align = "middle" ><p>
 Figure 2: Transformer Circuit Simulation in <b><i>LTSpice</i></b> </p>
</div>
...
<div align = "middle" ><p>
 Figure 3: Plot of Input(Green) and Output(Blue) signals of Transformer in <b><i>LTSpice</i></b> </p>
</div>
<br>
...
![Rectifier](images/Rectifier.gif)

<div align = "middle" ><p>Video 3: Rectifier Circuit Animation</p>
</div>
...
<div align = "middle" ><p>Figure 4: Transformer and Rectifier Circuit Simulation in <b><i>LTSpice</i></b></p>
</div>
<div align = middle>
...
<div align = "middle" ><p>Figure 5: Output Plot of Rectifier output in <b><i>LTSpice</i></b> </p>
</div>
...
capacitor. 
![Regulator](images/RegulatorCircuit.png)
<div id = filter align = "middle" ><p>
 Figure 8: Regulator Circuit Simulation in <b><i>LTSpice</i></b> </p>
</div>
...
![Graph of Regulated Output](images/RegulatorCircuitGraph.png)
<div id = filter align = "middle" ><p>Figure 9: Graphed Regulated Output Simulation in <b><i>LTSpice</i></b> </p>
</div>
<br>